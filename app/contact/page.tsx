            ...
            <div>
              ...
              <div className="mt-12">
                <iframe
                  ...
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2887.6163557385!2d1.4436700!3d43.6006700!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDPCsDM2JzAyLjQiTiAxwrAyNiczOS42IkU!5e0!3m2!1sfr!2sfr!4v1620000000000!5m2!1sfr!2sfr"
      ...
      <section className="bg-forest py-20 text-center">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-8 sm:flex-row sm:gap-12">
          ...
          <div>
            ...
            <p className="mt-1 font-lato text-sm text-white">05 61 XX XX XX</p>
          </div>
        </div>
      </section>
    </>
